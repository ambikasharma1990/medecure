...
sh 'sudo scp -o StrictHostKeyChecking=no -i ./terraform_files/project2.pem medicure-deployment.yml ubuntu@172.31.21.225:/home/ubuntu/'
sh 'sudo scp -o StrictHostKeyChecking=no -i ./terraform_files/project2.pem medicure-service.yml ubuntu@172.31.21.225:/home/ubuntu/'
script{
try{
sh 'ssh -i ./terraform_files/project2.pem ubuntu@172.31.21.225 kubectl apply -f .'
}catch(error)
{
sh 'ssh -i ./terraform_files/project2.pem ubuntu@172.31.21.225 kubectl apply -f .'
}
